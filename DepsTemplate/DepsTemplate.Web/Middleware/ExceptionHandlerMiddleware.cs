...
namespace DepsTemplate.Web.Middleware
{
    public class ExceptionHandlerMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            if (exception is DepsTemplateException geralException)
            {
            ...
            if (exception is AggregateException aggregate && aggregate.InnerExceptions.Any(x => x is DepsTemplateException DepsTemplateException))
            {
                var first = aggregate.InnerExceptions.Where(x => x is DepsTemplateException DepsTemplateException).First() as DepsTemplateException;
